...
VALUES 
    ('admin', 'password', 'The admin', 'admin', 'active'),
    ('john', 'password', 'John Smith', 'local','active'),
    ('jane', 'password', 'Jane Doe' , 'local' ,'inactive'),
    ('jim', 'password', 'Jim Harley' ,  'provincial', 'active'),
    ('jack', 'password', 'Jack Sparow' , 'provincial' , 'inactive');
